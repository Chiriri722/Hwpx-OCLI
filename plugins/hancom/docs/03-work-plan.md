...
공식 HWPML r1.2와 공개 281개 코퍼스, 한컴 2020 네이티브 DOCX를 다시 확보해
축 정렬 rectangle/rounded rectangle, 구조적 textbox, whole ellipse의 무손실
교집합을 구현했다. inline/페이지 floating, 중심 정렬, wrap/flow와 거리,
